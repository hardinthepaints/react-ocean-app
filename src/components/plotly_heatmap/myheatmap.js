...
import Plotly from 'plotly.js/dist/plotly-gl2d.js';
...
export default class MyHeatmap{
    ...
    constructor( div, json, width, height ){
        ...
        console.log( document.getElementById(this.div).data )
    ...
    initHeatmap( json ){
        ...
        var additionalArgs = {}
        if ( 'lon' in json[0] ){
            //additionalArgs = {x:json[0].lon, y:json[0].lat}
        }
        var myTrace = [Object.assign({}, trace[0], {z:z, visible:true }, additionalArgs) /*, Object.assign({}, trace[0], {z:z, visible:true, colorscale:altcolorscale, showscale:false}, additionalArgs)*/]
        var myLayout = Object.assign({}, layout)
        
        /* Initinally plot an empty heatmap */
        
        Plotly.plot(this.div, myTrace, myLayout,  {scrollZoom: false, staticPlot:true, displayModeBar:false, showLink:false}).catch(function(e){
            console.log(e);
        })
    ...
    relayout(newData){
        document.getElementById(this.div).data[0].z = newData
        Plotly.restyle(this.div, {}, 0)
    }
    ...
    playFrame(frame){
        ...
        //const graphDiv = document.getElementById( div )
        Plotly.animate(div, [frame], animationAttribs)
        
    }
    
    printData(div){
        console.log( document.getElementById(div).data )
    ...
    addFrames( json ) {
        ...
        json.map( function( frame, key ){
            ...
            frameNumbers.push(key+"")
        });
        
        Plotly.addFrames(this.div, processedFrames/*, frameNumbers*/)
        .catch(function(e){
            console.log(e);
        });
    ...
    processTrace(frame){
        return Object.assign({}, trace[0], {z:frame.z, visible:true})
    }
